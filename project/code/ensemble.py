...
model1 = lgb.LGBMRegressor(num_leaves=10,max_bin=119,min_data_in_leaf=11,learning_rate=0.02,bagging_fraction=1,min_sum_hessian_in_leaf=0.00245,bagging_freq=5,feature_fraction=0.05,lambda_l1=4.972,lambda_l2=2.276,min_gain_to_split=0.65,max_depth=14,save_binary=True,seed=1337,feature_fraction_seed=1337,bagging_seed=1337,drop_seed=1337,data_random_seed=1337,objective='binary',boosting_type='gbdt',verbose=1,boost_from_average=False,is_unbalance=True,metric='auc',random_state=42)



model2 = xgb.XGBClassifier(subsample=0.9539453486878958,scale_pos_weight=8.951238929246692,reg_lambda=0.5860531278003446,gamma=0.03277062133261745,reg_alpha=0.018906758484967926,min_child_weight=1,max_delta_step=19,max_depth=8,colsample_bylevel=0.8390144719977516,colsample_bytree=0.8844821246070537,learning_rate = 0.1, n_estimators = 8000,tree_method='approx')
