...
def objective(params, n_folds = N_FOLDS):
    ...
    for parameter_name in ['num_leaves', 'subsample_for_bin', 'min_child_samples', 'max_bin', 'bagging_freq']:
...
def run_trials():
    ...
    params = {
        ...
        'max_bin': 120,
        'min_sum_hessian_in_leaf': hp.loguniform('min_sum_hessian_in_leaf', np.log(0.0001), np.log(0.2)),
        'bagging_fraction': 1.0, 
        'bagging_freq': hp.uniform('bagging_freq', 0, 10), 
        'min_gain_to_split': hp.uniform('min_gain_to_split', 0.0, 1.0), # used to control regularization 
        ...
        'min_child_samples': hp.quniform('min_child_samples', 5, 500, 5),  # min_data_in_leaf
    ...
    best = fmin(fn=objective, space=params, algo=tpe.suggest, max_evals=max_trials, trials=trials)
