...
Figure~\ref{fig:fig} shows the comparison between true/false positive/negative metrics as well as accuracies
\begin{figure}[!ht]
 \centering
\includegraphics[width=6.1in]{assignment2/80-20_barcharts_algorithms.png}
\caption{\label{fig:fig4}bar charts of metrics/accuracies and algorithms}
\end{figure}
Figure~\ref{fig:fig} shows the comparison between true/false positive/negative metrics as well as accuracies
\begin{figure}[!ht]
 \centering
\includegraphics[width=6.1in]{assignment2/t}
\caption{\label{fig:fig4}bar charts of metrics/accuracies and algorithms}
\end{figure}
